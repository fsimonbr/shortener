...
RedisModel.prototype.deleteKey = function (short_url, callback,brand) {
  this.db.del(this.kHash(short_url), function (err, reply) {
    if (typeof callback === 'function') {
      callback(err, {'short_url':short_url,'status':'deleted'});
    }
  });
};
